    ...
    if (this.isCallbackConfigured('silent', callbackSilentLoginUrl, callbackSilentLoginRoute)) {
      ...
      OIDC.prototype.silentLogin = async function (req, res, next) {
        ...
        return ((req, res, next) => {
          ...
          // const shouldTrySilentLogin = this.shouldTrySilentLogin(req)
          const shouldTrySilentLogin = false

          if (req.session.anonymous && !shouldTrySilentLogin) {
          ...
          // On multiple simultaneous silent requests we need to
