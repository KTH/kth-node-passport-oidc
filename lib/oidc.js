...
class OIDC {
  ...
  loginSilent = () => Promise.reject(new Error("Not configured"));
  logout = () => Promise.reject(new Error("Not configured"));
    ...
    const loginStrategy = new Promise(async (resolve, reject) => {
      ...
      const loginStrategy = new Strategy(
        ...
        (req, tokenSet, done) => {
          ...
          this.createUserFromClaims(tokenSet.claims(), extendUser).then(
            (user) => {
